...
class pcie_tl_regression_test extends pcie_tl_base_test;
...
virtual task run_phase();
    ...
    // -------------------------------
    pcie_tl_sanity_test                 sanity;
    pcie_tl_smoke_test                  smoke;
    pcie_tl_memory_write_test           mem_wr;
    pcie_tl_memory_read_test            mem_rd;
    pcie_tl_configuration_read_test     cfg_rd;
    pcie_tl_configuration_write_test    cfg_wr;
    pcie_tl_completion_validation_test  cpl;
    pcie_tl_mixed_memory_config_test    mix;
    pcie_tl_negative_test               neg;
    pcie_tl_constrained_random_test     rand_test;
    pcie_tl_back_to_back_test           b2b;
    pcie_tl_stress_1000_test            stress;
    ...
    // -------------------------------
    // Mixed Memory/Configuration Test
    // -------------------------------
    mix.env = env;
    mix.run_phase();
    env.wait_for_drain();
